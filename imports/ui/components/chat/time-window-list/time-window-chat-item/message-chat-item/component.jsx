...
class MessageChatItem extends PureComponent {
  ...
  render() {
    ...
    if (type === 'poll') {
      ...
      return (
        <p
          style={(systemMessageType === "chatWelcomeMessageText" ? pStyle : pStyle2) }
          className={className}
          ref={(ref) => { this.text = ref; }}
          dangerouslySetInnerHTML={{ __html:  ((systemMessageType !== "chatWelcomeMessageText" || institutionWelcomeMessage === "false") ? text : institutionWelcomeMessage) }}
