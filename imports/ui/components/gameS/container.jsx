...
import PollService from '/imports/ui/components/gameT/service';
...
const PollingContainer = ({ pollExists, ...props }) => {
  const showPolling =  pollExists && !props.currentUser.presenter && POLLING_ENABLED;
...
export default withTracker(() => {
  ...
  const currentUser = Users.findOne({ userId: Auth.userID }, { fields: { presenter: 1, serverTimeDif: 1 } });
  return ({
    pollExists,
    handleVote,
    handleTypedVote,
