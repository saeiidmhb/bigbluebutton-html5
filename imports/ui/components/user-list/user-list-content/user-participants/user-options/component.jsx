...
const intlMessages = defineMessages({
  ...
  disableInactiveTabDetection: {
    id: 'app.userList.userOptions.disableInactiveTabDetectionLabel',
    description: '',
  },
  enableInactiveTabDetection: {
    id: 'app.userList.userOptions.enableInactiveTabDetectionLabel',
    description: '',
  },
});
...
class UserOptions extends PureComponent {
  constructor(props) {
    ...
    this.inactiveTabId = _.uniqueId('list-item-');
  ...
  renderMenuItems() {
    ...
    if (isMeteorConnected) {
      if (!meetingIsBreakout) {
        this.menuItems.push({
          key: this.inactiveTabId,
          label: intl.formatMessage(intlMessages[isInactiveTabDetectionEnabled ? 'disableInactiveTabDetection' : 'enableInactiveTabDetection']),
          // description: intl.formatMessage(intlMessages[isMeetingMuted ? 'unmuteAllDesc' : 'muteAllDesc']),
          onClick: toggleInactiveTabDetection ,
          icon: 'user',
        });
