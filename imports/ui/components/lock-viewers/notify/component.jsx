...
const intlDisableMessages = defineMessages({
  ...
  disableCamLimitedCon: {
    id: 'app.userList.userOptions.disableCamLimitedCon',
    description: 'label to disable cam for limited connections notification',
  },
  applied: {
    id: 'app.userList.userOptions.applied',
    description: 'label for applied notification (not used)',
  },
  disableMic: {
...
const intlEnableMessages = defineMessages({
  ...
  disableCamLimitedCon: {
    id: 'app.userList.userOptions.enableCamLimitedCon',
    description: 'label to disable cam for limited connections notification',
  },
  applied: {
    id: 'app.userList.userOptions.applied',
