...
const intlMessages = defineMessages({
  ...
  limitedConnectionWebcamLabel: {
    id: 'app.lock-viewers.limitedConnectionWebcamLabel',
    description: 'label for webcam toggle',
  },
...
class LockViewersComponent extends Component {
  ...
  render() {
    ...
    let { lockSettingsProps, usersProp } = this.state;
          ...
          <div className={styles.form}>
            ...
            <div className={styles.row}>
              <div className={styles.col} aria-hidden="true">
                <div className={styles.formElement}>
                  <div className={styles.label}>
                    {intl.formatMessage(intlMessages.limitedConnectionWebcamLabel)}
                  </div>
                </div>
              </div>
              <div className={styles.col}>
                <div className={cx(styles.formElement, styles.pullContentRight)}>
                  {this.displayLockStatus(lockSettingsProps.disableCamLimitedCon)}
                  <Toggle
                    icons={false}
                    defaultChecked={lockSettingsProps.disableCamLimitedCon}
                    onChange={() => {
                      this.toggleLockSettings('disableCamLimitedCon');
                    }}
                    ariaLabel={intl.formatMessage(intlMessages.limitedConnectionWebcamLabel)}
                    showToggleLabel={showToggleLabel}
                    invertColors={invertColors}
                  />
                </div>
        ...
        <div className={styles.footer}>
          <div className={styles.actions}>
            ...
            <Button
              ...
              onClick={() => {
                lockSettingsProps.applied = true;
