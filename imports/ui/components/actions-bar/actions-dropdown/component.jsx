...
const intlMessages = defineMessages({
  ...
  gameBtnLabel: {
    id: 'app.actionsBar.actionsDropdown.gameBtnLabel',
    description: 'game menu toggle button label',
  },
  gameBtnDesc: {
    id: 'app.actionsBar.actionsDropdown.gameBtnDesc',
    description: 'game menu toggle button description',
  },
  takePresenter: {
...
class ActionsDropdown extends PureComponent {
  ...
  handleExternalVideoClick() {
    const { mountModal, serverUrl, projectID, success } = this.props;
    mountModal(<ExternalVideoModal serverUrl={serverUrl} projectID={projectID} success={success}/>);
  }
  ...
  getAvailableActions() {
    ...
    if (amIPresenter && isPollingEnabled) {
      actions.push({
        icon: "happy",
        dataTest: "game",
        label: formatMessage(gameBtnLabel),
        key: "action-item-00",
        onClick: () => {
